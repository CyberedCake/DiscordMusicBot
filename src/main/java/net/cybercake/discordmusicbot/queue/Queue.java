...
public class Queue {
    ...
    private final List<AudioTrack> literalQueue;
    ...
    public List<AudioTrack> getLiteralQueue() { return this.literalQueue; }
    ...
    public void playNextTrack(boolean interrupt) {
        if(this.scheduler.audioPlayer.startTrack(this.literalQueue.get(this.currentIndex), !interrupt))
            this.currentIndex++;
    }
